...
For project-specific sponsorship and public roadmap targets, see:

- [SUPPORT.md](../SUPPORT.md)
- [Promo kit](../docs/public/promo-kit.md)
- [Sponsorware roadmap](../docs/public/sponsorware.md)
...
Best payment note: `qq-ai-bot #26 arm64` for the current physical-host validation target, or `qq-ai-bot setup` for general setup help.
