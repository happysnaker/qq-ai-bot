...
| [#26 arm64 / CasaOS deployment validation](https://github.com/happysnaker/qq-ai-bot/issues/26) | multi-arch image and v0.1.7 arm64 QEMU smoke confirmed; [tester pack](arm64-casaos-tester-pack.md) and [outreach kit](homelab-outreach-kit.md) published; real CasaOS/arm64 install report still open | helps homelab / CasaOS users know what is actually tested | ¥50 |
