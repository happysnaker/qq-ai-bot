...
|---|---|---|---:|
| [#23 End-to-end latency histograms](https://github.com/happysnaker/qq-ai-bot/issues/23) | measure receive → agent → reply latency | helps operators debug slow QQ / OneBot / ACP turns | ¥80 |
